...
<html>
    ...
    <?php include('../inc/site-head-sub.php'); ?>
...
<body>
    ...
    <div class="content-default">
        ...
        <div class="pure-g hero-object">
            <div class="pure-u-1">
                <img src="../graphics/images/objects/smalltroi.png">
            </div>
        </div>
        <h2 class="orange center bold">Малое Троицкое</h2>
        ...
        <p>Земельный участок — Малое Троицкое общей S = 61,4183 га. Сдаётся в аренду от 1 га. Категория земель: земли сельскохозяйственного назначения, разрешённое использование: для ведения сельскохозяйственного производства.Подходит под пашню, сенокос, с/х-производство. Использование под сенокос- 500 руб.га в сезон.</p>
    </div>

    <?php include('../inc/site-background-1.php'); ?>
