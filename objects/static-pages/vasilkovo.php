...
<body>
    ...
    <div class="content-default">
        ...
        <div class="pure-g hero-object">
            <div class="pure-u-1">
                <img src="../graphics/images/objects/Vasilkovo.png">
            </div>
        </div>
        <h2 class="orange center bold">Васильково</h2>
        ...
        <p> Земельный участок — Мучихино 1 общей S = 5, 0476 га. Сдаётся в аренду от 1 га. Категория земель: земли сельскохозяйственного назначения, разрешённое использование: для ведения сельскохозяйственного производства. Подходит под пашню, сенокос, с/х-производство.</p>
    </div>
